...
import com.ecommerce.catalog.server.exception.handler.LowerCaseClassNameResolver;
...
public class ErrorMessage {
	...
	private void addValidationError(String object, String field, Object rejectedValue, String message) {
		addSubError(new ValidationErrorMessage(object, field, rejectedValue, message));
	}
